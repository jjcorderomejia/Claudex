...
export function ThemePicker(t0: ThemePickerProps) {
  ...
  let t21;
  if ($[35] !== columns) {
    t21 = <Box flexDirection="column" borderTop={true} borderBottom={true} borderLeft={false} borderRight={false} borderStyle="dashed" borderColor="subtle">{React.createElement(StructuredDiff as React.ComponentType<Record<string, unknown>>, {patch: t20, dim: false, filePath: "demo.js", firstLine: null, width: columns})}</Box>;
    $[35] = columns;
    $[36] = t21;
  } else {
    t21 = $[36];
