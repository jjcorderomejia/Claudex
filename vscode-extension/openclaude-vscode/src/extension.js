...
const CLAUDEX_REPO_URL = 'https://github.com/l3tchupkt/claudex';
...
<body>
  <div class="panel">
    <div class="topbar">
      <span>claudex control center</span>
    ...
    <div class="content">
      ...
      <div class="terminal-box">
        <div class="terminal-row"><span class="prompt">$</span> claudex --status</div>
      ...
      <div class="actions">
        <button class="btn primary" id="launch">Launch Claudex</button>
        <button class="btn" id="docs">Open Repository</button>
        <button class="btn" id="commands">Open Command Palette</button>
      </div>

      <div class="hint">
        Quick trigger: use <code>${status.shortcut}</code> and run Claudex commands from anywhere.
      </div>
    </div>
  </div>
...
function activate(context) {
  ...
  const providerDisposable = vscode.window.registerWebviewViewProvider('claudex.controlCenter', provider);
